...
Hooks.once("init", () => {
    ...
    if (isNewerVersion(game.modules.get("token-factions").data.version, "0.2.1")) {
        Object.defineProperty(Token.prototype, "factions", {
            get() {
                return this._pv_factions;
            },
            set(value) {
                Board.place(`Token#${this.id}.factions`, value, Board.LAYERS.TOKEN_BASES, Board.Z_INDICES.PARENT);

                this._pv_factions = value;
            }
        });

        patch("Token.prototype.destroy", "PRE", function () {
            Board.unplace(`Token#${this.id}.factions`);
