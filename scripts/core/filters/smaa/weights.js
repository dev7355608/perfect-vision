import { default as smaaAreaTexture } from "./textures/area.js";
import { default as smaaSearchTexture } from "./textures/search.js";
...
export class SMAABlendingWeightCalculationFilter extends PIXI.Filter {
    constructor(sprite) {
        super(vertexSource, fragmentSource);

        this.sprite = sprite;
        this.uniforms.areaTex = smaaAreaTexture;
        this.uniforms.searchTex = smaaSearchTexture;
    }
